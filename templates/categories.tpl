...
<li class="alert alert-info"><span class="list-span">{'Kategorien'|gettext}</span>
<span class="list-span">{'Anzahl'|gettext}</span><span class="list-span">{'Aktionen'|gettext}</span></li>';
...
<ul class="categories list-group">
<li class="alert alert-info"><span class="list-span">{'Unterkategorien'|gettext}</span>
<span class="list-span">{'Anzahl'|gettext}</span><span class="list-span">{'Aktionen'|gettext}</span><span class="list-span">{'Oberkategorie'|gettext}</span></li>';
        ...
        <script type="text/javascript">
            ...
            for (let button of removalButtons) {
                button.addEventListener('click', function (evt) {
                    let targetType = evt.target.name === 'removeCategory' ? '{/literal}{'Kategorie wirklich entfernen?'|gettext}{literal}' : '{/literal}{'Unterkategorie umbenennen?'|gettext}{literal}'
            ...
            for (let button of editCategoryButtons) {
                button.addEventListener('click', function (evt) {
                    let targetType = evt.target.name === 'editCategory' ? '{/literal}{'Kategorie umbenennen?'|gettext}{literal}' : '{/literal}{'Unterkategorie umbenennen?'|gettext}{literal}'
